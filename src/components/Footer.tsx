      ...
      <div className="page-wrap px-4 py-16 grid gap-10 sm:grid-cols-[2fr_1fr_1fr]">
        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="m-0 list-none space-y-2.5 p-0 text-sm">
            ...
            <li>
              <a href="https://www.youtube.com/@FirstWalkUS" target="_blank" rel="noopener noreferrer" className="text-cream/70 no-underline hover:text-cream transition-colors">
                YouTube: @FirstWalkUS
              </a>
            </li>
            <li className="pt-2">
              <Link to="/contact" className="inline-flex items-center gap-2 rounded-full bg-gold/10 px-4 py-2 text-xs font-bold text-gold ring-1 ring-gold/20 hover:bg-gold hover:text-white transition-all no-underline">
                立即聯絡我 →
              </Link>
            </li>
          </ul>
